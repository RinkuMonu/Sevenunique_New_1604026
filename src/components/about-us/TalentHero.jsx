            ...
            <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 items-center gap-12">
                ...
                <div>
                    ...
                    <h1 className="text-[48px] md:text-[56px] leading-[1.1] font-semibold text-[#111827]">
                        ...
                        you only the <span className="text-[#f66135]">top 1%</span> of <br />
                        tech talent.
                    </h1>

                    <p className="mt-6 text-[16px] leading-[1.7] text-gray-600 max-w-xl">
                        Since 2009, we’ve built thousands of high-performing development teams.
                        Behind that track record is a rigorous vetting process designed to identify
                        professionals with the technical depth, collaboration skills, and AI fluency
                        modern software teams need.
                    </p>

                    <button className="mt-8 bg-[#f66135] hover:bg-[#f66135] transition text-white px-6 py-3 rounded-lg text-base">
