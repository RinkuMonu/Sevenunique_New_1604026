      ...
      <div className="max-w-[1200px] mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          <h2 className="text-[28px] md:text-[36px] lg:text-[40px] font-semibold text-[#111] leading-tight mb-8 max-w-md">
            Our work has been recognized with multiple awards and accolades.
          </h2>
        ...
        <div className="flex gap-4 md:gap-6 lg:ml-20">
          ...
          <div className="flex flex-col gap-4 md:gap-6 md:-mt-6 lg:-mt-10">
            <Card logo="/images/pcidss.png" text="America's fastest-growing companies 2025" />
            <Card logo="/images/msme.png" text="Enterprise excellence and IT Innovation 2025" />
            <Card logo="/images/iso.png" text="Computerworld's Best Places to Work in IT 2026" />
          </div>

          {/* RIGHT COLUMN */}
          <div className="flex flex-col gap-4 md:gap-6 mt-4 md:mt-6 lg:mt-10">
            <Card logo="/images/iaf.png" text="VentureBeat's Women in AI Awards - Finalist 2025" />
            <Card logo="/images/certified.avif" text="America's Fastest-growing Companies list 2025" />
          </div>
