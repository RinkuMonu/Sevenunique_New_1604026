...
export default function apiterms() {
        ...
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg text-gray-800">
              This section forms part of the SevenUnique Enterprise Legal Framework for API Terms
                of Service.
            </p>
 ...
 {/* Overview Section */}
          ...
          <p className="text-lg leading-relaxed  text-gray-500 ">
            SevenUnique Tech Solutions Private Limited provides enterprise software
development, SaaS platforms, APIs, AI services, cloud solutions and IT consulting.
Customers must use the services only for lawful purposes, protect credentials, comply
with applicable laws, and avoid unauthorized access or misuse. SevenUnique may
suspend or terminate access for fraud, abuse, non-payment, security threats or legal
requirements. Unless otherwise agreed in writing, intellectual property, confidentiality,
payment obligations, security requirements, limitation of liability, and dispute
resolution shall be governed by the applicable agreement and the laws of India.
Technical and organizational safeguards are implemented to protect customer
